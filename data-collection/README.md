...
Install the data read permissions stack. This will create the data read permissions required by the data collectors that will be deployed in the linked accounts (see [next section](#in-data-collection-account)):
